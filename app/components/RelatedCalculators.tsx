...
const CATEGORIES: Record<string, { href: string; icon: string; title: string }[]> = {
  "부동산": [
    ...
    { href: "/deposit-return-calc", icon: "🔒", title: "전세 보증금 반환 계산기" },
    { href: "/monthly-rent-calc", icon: "🏠", title: "월세 계산기" },
  ...
  "급여·재테크": [
    ...
    { href: "/monthly-salary-calc", icon: "💵", title: "월급 계산기" },
    { href: "/hourly-calc", icon: "⏰", title: "시급 계산기" },
    { href: "/health-insurance-calc", icon: "🏥", title: "건강보험료 계산기" },
  ...
  "세금": [
    ...
    { href: "/inheritance-calc", icon: "🏛️", title: "상속세 계산기" },
    { href: "/vat-calc", icon: "🧾", title: "부가가치세 계산기" },
    { href: "/customs-calc", icon: "📦", title: "관세 계산기" },
    { href: "/freelance-tax-calc", icon: "💼", title: "프리랜서 세금 계산기" },
    { href: "/jongbu-calc", icon: "🏘️", title: "종합부동산세 계산기" },
    { href: "/acquisition-tax-calc", icon: "🏠", title: "취득세 계산기" },
    { href: "/property-tax-calc", icon: "🏡", title: "재산세 계산기" },
    { href: "/car-tax-calc", icon: "🚗", title: "자동차세 계산기" },
  ],
  "교육": [
    { href: "/gpa-calc", icon: "🎓", title: "학점 계산기" },
    { href: "/suneung-calc", icon: "📝", title: "수능 등급 계산기" },
    { href: "/naesin-calc", icon: "📋", title: "내신 등급 계산기" },
    { href: "/tuition-calc", icon: "🎓", title: "대학 등록금 계산기" },
    { href: "/scholarship-calc", icon: "📚", title: "장학금 계산기" },
    { href: "/education-tax-calc", icon: "📝", title: "교육비 세액공제 계산기" },
  ],
  "법률": [
  ...
  "생활": [
    ...
    { href: "/pet-insurance-calc", icon: "🐾", title: "반려동물 보험 계산기" },
    { href: "/car-insurance-calc", icon: "🚗", title: "자동차 보험료 계산기" },
    { href: "/car-depreciation-calc", icon: "🚙", title: "자동차 감가상각 계산기" },
    { href: "/childcare-calc", icon: "👶", title: "육아비용 계산기" },
    { href: "/emergency-fund-calc", icon: "💰", title: "비상금 계산기" },
    { href: "/living-cost-calc", icon: "🏠", title: "생활비 계산기" },
    { href: "/travel-cost-calc", icon: "✈️", title: "여행 경비 계산기" },
    { href: "/wedding-cost-calc", icon: "💍", title: "결혼 비용 계산기" },
  ],
  "소비": [
